...
lazy_static::lazy_static! {
    ...
    pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
        ...
        map.insert("password".to_string(), "AK@2024.com".to_string());
        RwLock::new(map)
};
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["ak.vipslayer.com"];
pub const PUBLIC_RS_PUB_KEY: &str = "v2JzAPVgwPgDiUBVmNCiU0nfrFEp8rE0cv5MGQmvoQI=";
